$(window).on("turbolinks:load",function() {
  if (document.location.href.match(/\/items\/\d+\/edit/)){
    ...
    gon.images.forEach(function(image, index){
      var img = $(`<div class= "img_view  "><div class="img_area "><img src=${image.src.url} class="image" width ="120" height="80" ></div></div>`);
  
      // カスタムデータ属性を付与
      img.data("image", index);
      img.val( image.id )
      var btn_wrapper = $('<div class="btn_wrapper"><a class="btn_edit"></a><a class="btn_delete">削除</a></div>');
